...
var unmarshalTests = []struct {
	...
	{CaseName: Name(""), in: `{"X": 23}`, ptr: new(T), out: T{}, err: &UnmarshalTypeError{"number", typeFor[string](), len64(`{"X": `), "T", "X", nil}},
	...
	{CaseName: Name(""), in: `{"T": {"X": 23}}`, ptr: new(TOuter), out: TOuter{}, err: &UnmarshalTypeError{"number", typeFor[string](), len64(`{"X": `), "T", "X", nil}},
	...
	// integer-keyed map errors
	{
		...
		ptr:      new(map[int]string),
		out:      map[int]string{},
		err:      &UnmarshalTypeError{Value: "number abc", Type: typeFor[int](), Field: "abc", Offset: len64(`{`)},
	},
	{
		CaseName: Name(""),
		in:       `{"256":"abc"}`,
		...
		err:      &UnmarshalTypeError{Value: "number 256", Type: typeFor[uint8](), Field: "256", Offset: len64(`{`)},
	},
	{
		CaseName: Name(""),
		in:       `{"128":"abc"}`,
		...
		out:      map[int8]string{},
		err:      &UnmarshalTypeError{Value: "number 128", Type: typeFor[int8](), Field: "128", Offset: len64(`{`)},
	},
	{
		CaseName: Name(""),
		in:       `{"-1":"abc"}`,
		ptr:      new(map[uint8]string),
		out:      map[uint8]string{},
		err:      &UnmarshalTypeError{Value: "number -1", Type: typeFor[uint8](), Field: "-1", Offset: len64(`{`)},
	},
	{
		CaseName: Name(""),
		in:       `{"F":{"a":2,"3":4}}`,
		...
		err:      &UnmarshalTypeError{Value: "number a", Type: typeFor[int](), Field: "F.a", Offset: len64(`{"F":{`)},
	},
	{
		CaseName: Name(""),
		in:       `{"F":{"a":2,"3":4}}`,
		...
		err:      &UnmarshalTypeError{Value: "number a", Type: typeFor[uint](), Field: "F.a", Offset: len64(`{"F":{`)},
	},
	...
	// issue 8305
	{
		...
		err:      &UnmarshalTypeError{Value: "string", Type: typeFor[Point](), Field: `2009-11-10T23:00:00Z`, Offset: len64(`{`)},
	},
	{
		CaseName: Name(""),
		in:       `{"asdf": "hello world"}`,
		...
		err:      &UnmarshalTypeError{Value: "string", Type: typeFor[unmarshaler](), Field: "asdf", Offset: len64(`{`)},
	},
	...
	{CaseName: Name(""), in: `{"B": "maybe"}`, ptr: new(B), err: &UnmarshalTypeError{Value: `string "maybe"`, Type: typeFor[bool](), Struct: "B", Field: "B", Offset: len64(`{"B": `), Err: strconv.ErrSyntax}},
	{CaseName: Name(""), in: `{"B": "tru"}`, ptr: new(B), err: &UnmarshalTypeError{Value: `string "tru"`, Type: typeFor[bool](), Struct: "B", Field: "B", Offset: len64(`{"B": `), Err: strconv.ErrSyntax}},
	{CaseName: Name(""), in: `{"B": "False"}`, ptr: new(B), err: &UnmarshalTypeError{Value: `string "False"`, Type: typeFor[bool](), Struct: "B", Field: "B", Offset: len64(`{"B": `), Err: strconv.ErrSyntax}},
	{CaseName: Name(""), in: `{"B": "null"}`, ptr: new(B), out: B{false}},
	{CaseName: Name(""), in: `{"B": "nul"}`, ptr: new(B), err: &UnmarshalTypeError{Value: `string "nul"`, Type: typeFor[bool](), Struct: "B", Field: "B", Offset: len64(`{"B": `), Err: strconv.ErrSyntax}},
	...
	// UnmarshalTypeError without field & struct values
	{
		...
		err:      &UnmarshalTypeError{Value: "number", Type: typeFor[string](), Offset: len64(`{"data":{"test1": "bob", "test2": `), Struct: "mapStringToStringData", Field: "data.test2"},
	},
	{
		CaseName: Name(""),
		...
		err:      &UnmarshalTypeError{Value: "number", Type: typeFor[string](), Offset: len64(`{"data":{"test1": `), Struct: "mapStringToStringData", Field: "data.test1"},
	},
	...
	// trying to decode JSON arrays or objects via TextUnmarshaler
	{
		...
		err:      &UnmarshalTypeError{Value: "array", Type: typeFor[MustNotUnmarshalText](), Err: errors.New("JSON value must be string type")},
	},
	{
		CaseName: Name(""),
		in:       `{"foo": "bar"}`,
		ptr:      new(MustNotUnmarshalText),
		err:      &UnmarshalTypeError{Value: "object", Type: typeFor[MustNotUnmarshalText](), Err: errors.New("JSON value must be string type")},
	},
	// #22369
	{
		CaseName: Name(""),
	...
	},
	{
		...
		ptr:      new([]int),
		out:      []int{1, 2, 0, 4, 5},
		err:      &UnmarshalTypeError{Value: "bool", Type: typeFor[int](), Field: "2", Offset: len64(`[1,2,`)},
	},
...

	{
		...
		out:      NestedUnamed{},
		err:      &UnmarshalTypeError{Value: "string", Type: typeFor[int](), Offset: 10, Struct: "NestedUnamed", Field: "F.V"},
	},
	{
		...
		ptr:      new(error),
		out:      error(nil),
		err:      &UnmarshalTypeError{Value: "number", Type: typeFor[error]()},
	},
	{
		...
		ptr:      new(chan int),
		out:      (chan int)(nil),
		err:      &UnmarshalTypeError{Value: "number", Type: typeFor[chan int]()},
	},
	...
	},
	{
		...
		err: &UnmarshalTypeError{Value: "number 123 ", Type: typeFor[int64](), Field: "X", Offset: int64(len(`{"X": `))},
	},
	{
	...
	},
	{
		...
		err: &UnmarshalTypeError{Value: "number 0x123", Type: typeFor[uint64](), Field: "X", Offset: int64(len(`{"X": `))},
	},
	{
	...
	},
	{
		...
		err: &UnmarshalTypeError{Value: "number 1.5e1_", Type: typeFor[float64](), Field: "X", Offset: int64(len(`{"X": `))},
	},
}
...
func TestInterfaceSet(t *testing.T) {
	errUnmarshal := &UnmarshalTypeError{Value: "object", Offset: 5, Type: typeFor[int](), Field: "X"}
	tests := []struct {
		CaseName
		pre  any
		json string
...
func TestInvalidUnmarshal(t *testing.T) {
	tests := []struct {
		...
		{Name(""), `123`, new(net.IP), &UnmarshalTypeError{Value: "number", Type: typeFor[net.IP](), Offset: len64(``), Err: errors.New("JSON value must be string type")}},
	}
	for _, tt := range tests {
		t.Run(tt.Name, func(t *testing.T) {
